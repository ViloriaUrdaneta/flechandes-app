...
export default function MainButton({ children }: MainButtonProps) {
  return (
    <div>
      <div className='flex items-center w-80 bg-gray-100 rounded-lg shadow-lg h-28'>
        <div className='flex'>
            <div className='ml-8'>
            ...
            <div className='text-center ml-5 mr-7'>
                <h3>00</h3>
                <button className='rounded-lg bg-sky-500 px-3 py-3 my-1 text-white font-semibold'>Publicar</button>
            </div>
        </div>
      </div>
    </div>

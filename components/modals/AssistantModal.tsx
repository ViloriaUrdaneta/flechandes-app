...
export default function AssitantModal({children, onRequestClose }: ModalProps) {
        ...
        <div className='fixed bottom-0 right-0 w-screen h-screen flex items-center justify-center'>
            ...
            <div className={`fixed bottom-0 justify-center bg-gray-200 w-full rounded-t-lg ${modalMarginBotton}`}>
                ...
                <div className='flex flex-col mt-8 items-center content-center gap-2 mx-auto'>
                    <button className='font-bold text-gray-400'>1</button>
                    <button className='font-bold text-gray-400'>2</button>
                    <button className='font-bold text-gray-400'>3</button>
                    <button className='font-bold text-gray-400'>Yo ayudo</button>
                </div>
                <div className='flex justify-evenly mt-8'>
                    ...
                    <button className='rounded-lg bg-sky-500 px-10 my-1 text-white font-semibold'>Aceptar</button>
                </div>
